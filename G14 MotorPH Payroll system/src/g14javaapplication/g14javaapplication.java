        ...
        button.addActionListener(e -> {
            switch (text) {
                case "Employee Info":
                    ...
                    break;
                case "Attendance":
                    // implement later or reuse EmployeeTableFrame
                    JOptionPane.showMessageDialog(frame, "Attendance feature coming soon.");
                    break;
                case "Payroll":
    ...
    private void addMainButton(String label, String iconPath, int x, int y) {
        ...
        buttonPanel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                switch (label) {
                    case "Employee Info":
                        new EmployeeTableFrame(null).setVisible(true); break;
                    case "Attendance":
                        JOptionPane.showMessageDialog(frame, "Attendance feature coming soon."); break;
                    case "Payroll":
                        new PayrollSelectionFrame().setVisible(true); break;
                    case "New Employee":
                        new NewEmployeeForm(new EmployeeTableFrame(null)).setVisible(true); break;
                }
            }
            @Override
            public void mouseEntered(MouseEvent e) {
    ...
    private void showCustomDialog(JFrame parent, String message) {
        ...
        okayButton.addMouseListener(new MouseAdapter() {
            @Override public void mouseEntered(MouseEvent e) {
                ...
                okayButton.setBorder(BorderFactory.createCompoundBorder(
